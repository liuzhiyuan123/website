var folkcam = {
    ...
    dynamicArr: [
        ...
        },
        {
            date: '03-07',
            year: '2019',
            title: '互利共赢，融合发展 ——滨海金控莅临镜玩科技参观指导',
            text: '双方希望通过交流，加深了解，为今后增进更深领域合作奠定基础，促进双方在互利互惠中实现共赢发展。',
            imgPath: 'img/20190307.jpg'
        },
        {
            date: '03-06',
            year: '2019',
    ...
    createdynamic: function () {
        ...
        for (var i = 0; i < arr.length; i++) {
            str += (function (num) {
                var obj = arr[num];
                return '<div class="dynamic-detail flexbox between ' + (num == 0 ? 'dynamic-active' : '') + '" onclick="goDetail(' + (+num + 1) + ')"><div class="detail-title"><h1>' + obj.date + '</h1><span class="fa fa-long-arrow-right"></span></div><div class="detail-text"><p>' + obj.title + '</p><p>' + obj.text + '</p></div><img class="detail-img" src="' + obj.imgPath + '" alt=""></div>'
            })(i)
        }
